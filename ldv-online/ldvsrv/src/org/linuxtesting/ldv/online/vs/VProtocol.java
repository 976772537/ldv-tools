package org.linuxtesting.ldv.online.vs;

public class VProtocol {
    public static final String sGetTask = "GETTASK";
    public static final String sGetTaskOk = "GETTASK_OK";
    public static final String sSendResults = "SENDRESULTS";
    public static final String sSendResultsOk = "SENDRESULTS_OK";
    public static final String sSendResultsFailed = "SENDRESULTS_FAILED";
