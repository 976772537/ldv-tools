                ...
                <ul>
                        ...
                        <ul>
                                ...
                                <li> Archive should contain:</li>
                                        o Makefile (written to be compiled against the kernel)<br>
                                                + obj-m is mandatory<br>
                                        o Source code files referenced by Makefile<br>
                                <li> Archive should not contain any files generated by build process (such as object files)</li>
                        </ul>
                        </li>
                        <li>
                        If you upload a kernel patch file:
                        <ul>
                                <li> File should be a patch in a plain text format, or an archive with plain text patches</li>
                                <li> If you upload an archive, it should contain <i>only</i> plain text patches; its format should be gzip or bzip2, and it should have one of the following extensions: .tar.bz2, tar.gz, .tgz</li>
                                <li> The patch should insert a line that changes obj-m </li>
                        </ul>
                        </li>
                </ul>
        </ul>
